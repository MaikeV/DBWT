        ...
        <div class="container-fluid p-3">
            <div class="row mt-3 text-warning">
                ...
                <div class="col-2 align-content-end justify-content-end align-items-end">
                    <button class="btnSign btn btn-primary mb-3"><img src="../img/fontawesome-free-5.11.2-desktop/svgs/solid/user-plus.svg" class="img-fluid icon "> Registrieren</button>
                    <br>
                    <button class="btnSign btn btn-primary"><img src="../img/fontawesome-free-5.11.2-desktop/svgs/solid/sign-in-alt.svg" class="img-fluid icon"> Anmelden</button>
                </div>
            </div>
            <div class="row mt-3 text-warning">
                <div class="col-2 text-left infoText">
