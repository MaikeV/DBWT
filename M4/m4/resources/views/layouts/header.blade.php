    ...
    <div class="container-fluid bg-primary mw-100 ">
        <div class="row align-items-end justify-content-center p-2">
            ...
            <div class="col-2 text-center border-right border-white">
                @if (basename($_SERVER['PHP_SELF']) == 'start')
                    <a class="text-dark font-weight-bolder">Start</a>
                @else
                    <a href="/start" class="text-white font-weight-bolder">Start</a>
                @endif
            </div>
            <div class="col-2 text-center border-right border-white">
                @if (basename($_SERVER['PHP_SELF']) == 'products')
                    <a class="text-dark font-weight-bolder">Mahlzeiten</a>
                @else
                <a href="/products" class="text-white font-weight-bolder">Mahlzeiten</a>
                @endif
            </div>
            <div class="col-2 text-center border-right border-white">
                @if (basename($_SERVER['PHP_SELF']) == 'orders')
                    <a class="text-dark font-weight-bolder">Bestellungen</a>
                @else
                    <a href="/orders" class="text-white font-weight-bolder">Bestellungen</a>
                @endif
            </div>
