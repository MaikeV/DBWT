    ...
    <div class="container-fluid bg-primary mw-100 ">
        <div class="row align-items-end justify-content-center p-2">
            ...
            <div class="col-2 text-center border-right border-white">
                ...
                @else
                    <a href="views/pages/Start.php" class="text-white font-weight-bolder">Start</a>
                @endif
            </div>
            <div class="col-2 text-center border-right border-white">
                ...
                @else
                <a href="views/pages/Mahlzeiten.php" class="text-white font-weight-bolder">Mahlzeiten</a>
                @endif
            </div>
            <div class="col-2 text-center border-right border-white">
                ...
                @else
                    <a href="views/pages/Bestellungen.php" class="text-white font-weight-bolder">Bestellungen</a>
                @endif
            </div>
